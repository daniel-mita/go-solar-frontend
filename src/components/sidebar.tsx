    ...
    >
      ...
      >
        <div style={{ paddingTop: 24 }}>
          <p style={{ fontSize: 16, padding: 0, margin: 0, fontWeight: 200 }}>
            Welcome,{' '}
          </p>
          <p
            style={{
        ...
        {type === 'pdfs' && (
          <div style={{ paddingTop: 24, width: '100%' }}>{renderUploadPDF}</div>
        )}
      </div>
      <div style={{ width: '100%' }}>
        <Button onClick={() => null} style={{ width: '100%' }} type="primary">
          Leave
        </Button>
      </div>
    </div>
